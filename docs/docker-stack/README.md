...
* `apache/airflow:slim-2.3.0`           - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:slim-2.3.0-pythonX.Y` - the versioned Airflow image with specific Python version
