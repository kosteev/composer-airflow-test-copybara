...
* `apache/airflow:2.3.1` - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:2.3.1-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-2.3.1`           - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:slim-2.3.1-pythonX.Y` - the versioned Airflow image with specific Python version
...
[Dockerfile](https://github.com/apache/airflow/bloInternal bugc6c7fdb2308de98e142618836bdf414df9768c8/Dockerfile#L37).
